...
<dict>
  ...
  <string>Dr. Medhat Clinic</string>
  <key>CFBundleDisplayName</key>
  <string>Dr. Medhat Clinic</string>
  <key>CFBundleIdentifier</key>
  <string>com.drmedhat.clinic</string>
...
# Native launcher to reopen browser on Dock click
LAUNCHER_SRC="$ROOT_DIR/.tmp_launcher.m"
...
/usr/bin/clang -arch x86_64 -mmacosx-version-min=10.13 -framework Cocoa -O2 -o "$APP_BUNDLE/Contents/MacOS/DrMedhatClinic" "$LAUNCHER_SRC"
rm -f "$LAUNCHER_SRC"
